        ...
        async  uploadPhoto(){
          ...
          if (this.state.fileUri == '') {
            ...
            try {
             ...
             RNFetchBlob.fetch('POST', `https://pro.faktodeks.com//api/cekArka/uploadImage`, {
  ...
  render() {
    return (
        ...
        <ImageBackground
         ...
         source={
          this.state.fileUri == '' ?   require('../images/cekArka.png') : require('../images/Background.png')
          }
       ...
       <Image
        ...
        <Row style={{justifyContent:'center',alignItems:'center',paddingHorizontal:30,height:70}}>
                  <Image
                      ...
                      source={require('../images/3adim.png')} 
                  />
                  </Row>
                 {this.state.fileUri == '' ? 
                <Row style={{ justifyContent:'center',alignItems:'center',flexDirection:'column',marginTop:30  }}>
                        <Subtitle style={{color:'white',fontSize:24,fontWeight:'bold'}}>Çekinizin arka yüzünü çekin</Subtitle>
              ...
              <Row style={{justifyContent:'center',alignItems:'center',flexDirection:'column',paddingHorizontal:30,height:70,marginTop:30}}>
                  <Subtitle style={{color:'white',fontSize:24,textAlign:'center'}}>Çekinizin arka yüzü yüklendi!</Subtitle>
                  <Image
        ...
        <Footer style={{backgroundColor: 'transparent'}}>
          <FooterTab style={{borderTopLeftRadius:50,borderTopRightRadius:50,backgroundColor:'white'}}>
            <Button transparent onPress={() => this.props.navigation.navigate('Taleplerim') }>
              ...
              <Button transparent
            onPress={()=> { this.state.showOkey == 1 ? this.props.navigation.navigate('CekFatura',{cekid:this.state.cekid}) : this.setModalVisible(true) }}
             > 
                 <Image
        ...
        <Modal
                        ...
                        <View style={{ flex: 1, borderRadius: 10, backgroundColor: 'rgba(135, 135, 135, 0.35)', justifyContent: 'center', alignItems: 'center' }} >
                            <View style={styles.modalViewLoading} >
                              ...
                              Çekinizin arka yüzü yükleniyor lütfen bekleyiniz
                                </Text>
