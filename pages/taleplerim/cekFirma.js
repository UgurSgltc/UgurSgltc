...
class cekFirma extends Component {
    constructor(props) {
        super(props);
        this.state = {
          iller:[],
        ...
        <ImageBackground source={require('../images/Background.png')}  style={{width: '100%', height: '100%'}}>
          ...
          <Modal
                    ...
                    <View style={{width:WIDTH/1.3,height:HEIGHT/2,borderRadius:20}}>  
                     ...
                     >
                      <Text style={{textAlign:'center',color:'#042264'}}>DAHA SONRA</Text>
                    </Button>
                    <TouchableOpacity   onPress={this.teklifAc.bind(this)} style={{marginTop:20,padding:10,width:'100%',backgroundColor:'#00FFF5',borderColor:'#042264',borderWidth:1, borderRadius:25,justifyContent:'center',alignItems:'center'}}>
                      <Text style={{textAlign:'center',color:'#042264'}}>TEKLİFLERE AÇ</Text>
                    </TouchableOpacity>
                     </Row>
                     </View>
                    </Grid>
...
export default withNavigation(cekFirma);
